...
当前状态：P0-01 release 构建通过；P0-02 已有参数/表情检查和渲染图；P0-03 已通过本机人工验收（采用用户确认的焦点和命中余量规则）；P0-04 已通过本机 Tauri/真实渲染宿主的生命周期自动验收；P0-05/06 仅取得部分证据。下一步验证工作区/坐标与屏幕吸附。**P0 Gate 尚未通过**，任务通过条件保持如下，不以部分试件替代完整验收。
