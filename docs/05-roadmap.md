...
以 1 名熟悉 Rust 与语音推理的开发者投入为估算，不包含额外美术制作、授权获取和模型训练时间。人日表示有效工作量而非承诺日期；阶段允许根据 P0 测量调整。当前所有阶段均未实施，只有设计与资源审计完成。
...
| P0-03 原生窗口 | Rust 透明窗口试件 | 深浅背景透明正确；不抢焦点；角色可拖拽，透明区点击落到其他 App |
