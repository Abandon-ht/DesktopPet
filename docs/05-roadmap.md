...
当前状态（2026-09-24）：P1-01 至 P1-03 已完成，P1-04 的动画、点击表情、视线范围及 100 次交互获用户确认，P1-05 的坐窗位置、跟随与高度微调获用户确认。P1-06 六项操作已完成，跨屏和 Finder/Safari/编辑器吸附均有用户反馈；窗口跟随滞后仍可感知，present 调用间隔 p95 略高于目标，两种测试包尚未合并验收，见 [P1-06 结果](14-p1-06-alpha-validation.md)。以下阶段整体目标保持不变。
