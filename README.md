...
设计日期：2026-09-16。目标：macOS 首发，Rust 为主要开发语言，后续支持 Windows、Linux。当前包含设计文档、P0 原生验证工具与 P1 开发版应用；P0 Gate 已通过，P1-02 与 P1-03 已通过用户桌面验收；P1-04 的动画、点击表情和可调视线范围已确认，100 次交互及多屏等仍待验收；P1-05 的坐窗位置、跟随和微调已确认，完整窗口/多屏验收及跟随滞后优化仍待完成。
